 ...
 */
namespace EasyCI202307\Symfony\Contracts\Service\Test;

use EasyCI202307\PHPUnit\Framework\TestCase;
...
abstract class ServiceLocatorTestCase extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\EasyCI202307\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\EasyCI202307\Psr\Container\ContainerExceptionInterface::class);
