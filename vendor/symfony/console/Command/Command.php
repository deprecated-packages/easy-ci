 ...
 */
namespace EasyCI202307\Symfony\Component\Console\Command;

use EasyCI202307\Symfony\Component\Console\Application;
use EasyCI202307\Symfony\Component\Console\Attribute\AsCommand;
...
use EasyCI202307\Symfony\Component\Console\Helper\HelperInterface;
...
class Command
{
    ...
    public function run(InputInterface $input, OutputInterface $output) : int
    {
        ...
        if (null !== $this->processTitle) {
            ...
            } elseif (\function_exists('EasyCI202307\\setproctitle')) {
