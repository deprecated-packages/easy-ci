...
use EasyCI202307\Doctrine\DBAL\Configuration;
use EasyCI202307\Doctrine\DBAL\DriverManager;
use EasyCI202307\Doctrine\DBAL\Schema\DefaultSchemaManagerFactory;
use EasyCI202307\Doctrine\DBAL\Tools\DsnParser;
use EasyCI202307\Relay\Relay;
use EasyCI202307\Symfony\Component\Cache\Adapter\AbstractAdapter;
/**
...
class SessionHandlerFactory
{
    ...
    public static function createHandler($connection, array $options = []) : AbstractSessionHandler
    {
        ...
        switch (\true) {
            ...
            case $connection instanceof \EasyCI202307\Predis\ClientInterface:
