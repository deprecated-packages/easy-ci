 ...
 */
namespace EasyCI202307\Symfony\Component\HttpKernel;

use EasyCI202307\Symfony\Bridge\ProxyManager\LazyProxy\Instantiator\RuntimeInstantiator;
use EasyCI202307\Symfony\Bridge\ProxyManager\LazyProxy\PhpDumper\ProxyDumper;
use EasyCI202307\Symfony\Component\Config\Builder\ConfigBuilderGenerator;
use EasyCI202307\Symfony\Component\Config\ConfigCache;
...
use EasyCI202307\Symfony\Component\DependencyInjection\Dumper\PhpDumper;
...
use EasyCI202307\Symfony\Component\DependencyInjection\Loader\ClosureLoader;
use EasyCI202307\Symfony\Component\DependencyInjection\Loader\DirectoryLoader;
use EasyCI202307\Symfony\Component\DependencyInjection\Loader\GlobFileLoader;
use EasyCI202307\Symfony\Component\DependencyInjection\Loader\IniFileLoader;
use EasyCI202307\Symfony\Component\DependencyInjection\Loader\PhpFileLoader;
use EasyCI202307\Symfony\Component\DependencyInjection\Loader\XmlFileLoader;
use EasyCI202307\Symfony\Component\DependencyInjection\Loader\YamlFileLoader;
use EasyCI202307\Symfony\Component\ErrorHandler\DebugClassLoader;
use EasyCI202307\Symfony\Component\Filesystem\Filesystem;
use EasyCI202307\Symfony\Component\HttpFoundation\Request;
use EasyCI202307\Symfony\Component\HttpFoundation\Response;
use EasyCI202307\Symfony\Component\HttpKernel\Bundle\BundleInterface;
use EasyCI202307\Symfony\Component\HttpKernel\CacheWarmer\WarmableInterface;
use EasyCI202307\Symfony\Component\HttpKernel\Config\FileLocator;
use EasyCI202307\Symfony\Component\HttpKernel\DependencyInjection\AddAnnotatedClassesToCachePass;
use EasyCI202307\Symfony\Component\HttpKernel\DependencyInjection\MergeExtensionConfigurationPass;
...
abstract class Kernel implements KernelInterface, RebootableInterface, TerminableInterface
{
    ...
    protected function initializeContainer()
    {
        ...
        if ($collectDeprecations = $this->debug && !\defined('EasyCI202307\\PHPUNIT_COMPOSER_INSTALL')) {
            $collectedLogs = [];
    ...
    protected function getContainerBuilder() : ContainerBuilder
    {
        ...
        if (\class_exists(\EasyCI202307\ProxyManager\Configuration::class) && \class_exists(RuntimeInstantiator::class)) {
    ...
    protected function dumpContainer(ConfigCache $cache, ContainerBuilder $container, string $class, string $baseClass)
    {
        ...
        if (\class_exists(\EasyCI202307\ProxyManager\Configuration::class) && \class_exists(ProxyDumper::class)) {
